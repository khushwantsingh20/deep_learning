...
ALLOWED_HOSTS += ["127.0.0.1", "localhost", "172.16.66.211", "172.16.64.166"]
...
INSTALLED_APPS += ("djrad_devtools",)
MIDDLEWARE += ("djrad_devtools.middleware.DjradDevtoolsRequestMiddleware",)
...
if _strtobool(get_env_setting("DJANGO_SILK", "0")):
    INSTALLED_APPS += ("silk",)
...
# DATABASES["default"]["NAME"] = get_env_setting("DB_NAME", "sc_booking_platform")
...
DATABASES = {
    'default': {
        ...
        'NAME': get_env_setting("DB_NAME", "testing"),
        'USER': get_env_setting("DB_USER", "postgres"),
        'PASSWORD': get_env_setting("DB_PASSWORD", "1234"),
...
CELERY_BROKER_URL = get_env_setting("REDIS_URL", "redis://localhost:6379")
