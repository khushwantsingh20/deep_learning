...
import useMemoOne, { shallowStrictEquals } from './useMemoOne';
 ...
 *
 * > **NOTE**: For use cases involving fetching model data [useGetModel](/api/js/hooks/#useGetModel)
 * > or [useListModel](/api/js/hooks/#useListModel) are often more appropriate instead.
 *
 * Any function that returns a Promise is supported. If you want to dispatch async redux action use
 * [useAsyncRedux](/api/js/hooks/#useAsyncRedux) instead.
 *
