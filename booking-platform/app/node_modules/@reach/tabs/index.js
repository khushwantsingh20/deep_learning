...
var Tabs = (0, _react.forwardRef)(function Tabs(_ref, ref) {
  ...
  process.env.NODE_ENV !== "production" ? (0, _warning2.default)(!(isControlled && controlledIndex == null), "Tabs is changing from controlled to uncontrolled. Tabs should not switch from controlled to uncontrolled (or vice versa). Decide between using a controlled or uncontrolled Tabs for the lifetime of the component. Check the `index` prop being passed in.") : void 0;

  process.env.NODE_ENV !== "production" ? (0, _warning2.default)(!(!isControlled && controlledIndex != null), "Tabs is changing from uncontrolled to controlled. Tabs should not switch from uncontrolled to controlled (or vice versa). Decide between using a controlled or uncontrolled Tabs for the lifetime of the component. Check the `index` prop being passed in.") : void 0;
  ...
  return _react2.default.createElement(Comp, _extends({ "data-reach-tabs": "", ref: ref }, props, { children: clones }));
});
...
process.env.NODE_ENV !== "production" ? Tabs.propTypes = {
  ...
  index: function index(props, name, compName) {
    ...
    if (props.index > -1 && props.onChange == null && props.readOnly !== true) {
      ...
      return _propTypes.number.apply(undefined, [name, props, compName].concat(rest));
    }
  },
...
var TabList = (0, _react.forwardRef)(function TabList(_ref2, ref) {
  ...
  var handleKeyDown = (0, _utils.wrapEvent)(onKeyDown, function (event) {
    var enabledIndexes = _react2.default.Children.map(children, function (child, index) {
...
var TabPanels = (0, _react.forwardRef)(function TabPanels(_ref4, ref) {
  ...
  return _react2.default.createElement(Comp, _extends({ "data-reach-tab-panels": "", ref: ref }, htmlAttrs, { children: clones }));
});
