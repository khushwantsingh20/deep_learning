// Credit to https://github.com/ReactTraining/react-router/blob/master/website/modules/components/FakeBrowser.js
...
const Block = ({ children, component = 'div', props, ...style }) =>
    React.createElement(component, { ...props, style }, children);

const Col = ({ children, className, ...rest }) => (
...
const Button = ({ children, ...props }) => (
    <Block
        ...
        activeTop="1px"
        activeLeft="1px"
        color={props.disabled ? 'graytext' : 'inherit'}
                    ...
                    render={({ history, location }) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <Row flex="1" alignItems="center" padding="5px" marginLeft="-15px">
                                    <input
                                        style={{
                                            font: 'inherit',
                                            width: '100%',
                            ...
                            <Block flex="1" padding="20px" overflow="auto" position="relative">
