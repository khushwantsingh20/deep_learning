...
export default function PasswordResetView(props) {
    ...
    switch (activationState) {
                        ...
                        <Col md={{ span: 16, offset: 4 }} lg={{ span: 14, offset: 5 }}>
                            <div className="mainContent">
                                ...
                                <p>
                                    ...
                                    <Link to="/request-password-reset">reset</Link> again to
                                    generate a new link.
                                </p>
                            </div>
                        </Col>
                    ...
                    <Row>
                        <Col md={{ span: 16, offset: 4 }} lg={{ span: 14, offset: 5 }}>
                            <div className="mainContent">
                                ...
                                <p>
                                    There seems to be a problem with your password reset link.
                                    Please <Link to="/request-password-reset">reset</Link> again to
                                    generate a new link.
                                </p>
                            </div>
                        </Col>
        ...
        default:
            return (
                <div>
                    <div className="mainContent">Validating reset request...</div>
                </div>
            );
    }
}
